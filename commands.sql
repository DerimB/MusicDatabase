--The Concat function is used to generate statements such as *artrist* recorded *album* and this is shown as the table named Recording
SELECT CONCAT(artist_name, ' recorded ', album_name) AS Recording
FROM artist
JOIN album ON artist.artist_id = album.artist_id;

--The select statement was fixed to ensure the artist and album name are shown.
...
--Uses the compiles relation between the artist and album tables, This gets the output of the artist_name and album_name attributes. (Same result as the previous command)
